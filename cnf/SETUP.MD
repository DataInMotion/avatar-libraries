...
The Maven group-id is defaulted to **avatar-libraries** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `avatar-libraries`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `avatar-libraries` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/avatar-libraries/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/avatar-libraries.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/avatar-libraries/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `avatar-libraries`
- [Jenkins avatar-libraries branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/avatar-libraries/)
