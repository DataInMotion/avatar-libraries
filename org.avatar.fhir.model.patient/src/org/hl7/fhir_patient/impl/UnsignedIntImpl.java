 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.UnsignedIntImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnsignedIntImpl extends ElementImpl implements UnsignedInt {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.UNSIGNED_INT;
	}
	...
	public void setValue(BigInteger newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.UNSIGNED_INT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fhir_PatientPackage.UNSIGNED_INT__VALUE:
				return getValue();
		}
