 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.DateImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateImpl extends ElementImpl implements Date {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.DATE;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.DATE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fhir_PatientPackage.DATE__VALUE:
				return getValue();
		}
