 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.CodeableConceptImpl#getCoding <em>Coding</em>}</li>
 *   <li>{@link org.hl7.fhir_patient.impl.CodeableConceptImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CodeableConceptImpl extends DataTypeImpl implements CodeableConcept {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.CODEABLE_CONCEPT;
	}
	...
	public EList<Coding> getCoding() {
		if (coding == null) {
			coding = new EObjectContainmentEList<Coding>(Coding.class, this, Fhir_PatientPackage.CODEABLE_CONCEPT__CODING);
		}
		return coding;
	}
	...
	public NotificationChain basicSetText(org.hl7.fhir_patient.String newText, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.CODEABLE_CONCEPT__TEXT, oldText, newText);
	...
	public void setText(org.hl7.fhir_patient.String newText) {
		if (newText != text) {
			...
			if (text != null)
				msgs = ((InternalEObject)text).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Fhir_PatientPackage.CODEABLE_CONCEPT__TEXT, null, msgs);
			if (newText != null)
				msgs = ((InternalEObject)newText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Fhir_PatientPackage.CODEABLE_CONCEPT__TEXT, null, msgs);
			msgs = basicSetText(newText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.CODEABLE_CONCEPT__TEXT, newText, newText));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Fhir_PatientPackage.CODEABLE_CONCEPT__CODING:
				return ((InternalEList<?>)getCoding()).basicRemove(otherEnd, msgs);
			case Fhir_PatientPackage.CODEABLE_CONCEPT__TEXT:
