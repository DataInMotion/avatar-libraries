 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.BackboneTypeImpl#getModifierExtension <em>Modifier Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BackboneTypeImpl extends DataTypeImpl implements BackboneType {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.BACKBONE_TYPE;
	}
	...
	public EList<Extension> getModifierExtension() {
		if (modifierExtension == null) {
			modifierExtension = new EObjectContainmentEList<Extension>(Extension.class, this, Fhir_PatientPackage.BACKBONE_TYPE__MODIFIER_EXTENSION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Fhir_PatientPackage.BACKBONE_TYPE__MODIFIER_EXTENSION:
