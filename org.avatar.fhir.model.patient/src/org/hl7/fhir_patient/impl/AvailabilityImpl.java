 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.AvailabilityImpl#getAvailableTime <em>Available Time</em>}</li>
 *   <li>{@link org.hl7.fhir_patient.impl.AvailabilityImpl#getNotAvailableTime <em>Not Available Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AvailabilityImpl extends DataTypeImpl implements Availability {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.AVAILABILITY;
	}
	...
	public EList<AvailabilityAvailableTime> getAvailableTime() {
		if (availableTime == null) {
			availableTime = new EObjectContainmentEList<AvailabilityAvailableTime>(AvailabilityAvailableTime.class, this, Fhir_PatientPackage.AVAILABILITY__AVAILABLE_TIME);
		}
	...
	public EList<AvailabilityNotAvailableTime> getNotAvailableTime() {
		if (notAvailableTime == null) {
			notAvailableTime = new EObjectContainmentEList<AvailabilityNotAvailableTime>(AvailabilityNotAvailableTime.class, this, Fhir_PatientPackage.AVAILABILITY__NOT_AVAILABLE_TIME);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Fhir_PatientPackage.AVAILABILITY__AVAILABLE_TIME:
				return ((InternalEList<?>)getAvailableTime()).basicRemove(otherEnd, msgs);
			case Fhir_PatientPackage.AVAILABILITY__NOT_AVAILABLE_TIME:
