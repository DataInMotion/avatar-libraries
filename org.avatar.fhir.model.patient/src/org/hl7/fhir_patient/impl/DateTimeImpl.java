 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.DateTimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateTimeImpl extends ElementImpl implements DateTime {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.DATE_TIME;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.DATE_TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fhir_PatientPackage.DATE_TIME__VALUE:
				return getValue();
		}
