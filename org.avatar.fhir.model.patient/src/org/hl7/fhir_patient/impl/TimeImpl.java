 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.TimeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeImpl extends ElementImpl implements Time {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.TIME;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.TIME__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fhir_PatientPackage.TIME__VALUE:
				return getValue();
		}
