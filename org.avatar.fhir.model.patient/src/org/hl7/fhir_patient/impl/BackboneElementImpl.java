 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.BackboneElementImpl#getModifierExtension <em>Modifier Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BackboneElementImpl extends ElementImpl implements BackboneElement {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.BACKBONE_ELEMENT;
	}
	...
	public EList<Extension> getModifierExtension() {
		if (modifierExtension == null) {
			modifierExtension = new EObjectContainmentEList<Extension>(Extension.class, this, Fhir_PatientPackage.BACKBONE_ELEMENT__MODIFIER_EXTENSION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Fhir_PatientPackage.BACKBONE_ELEMENT__MODIFIER_EXTENSION:
