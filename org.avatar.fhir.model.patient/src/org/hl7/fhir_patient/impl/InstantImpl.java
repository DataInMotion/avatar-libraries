 ...
 * </p>
 * <ul>
 *   <li>{@link org.hl7.fhir_patient.impl.InstantImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstantImpl extends ElementImpl implements Instant {
	...
	protected EClass eStaticClass() {
		return Fhir_PatientPackage.Literals.INSTANT;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fhir_PatientPackage.INSTANT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Fhir_PatientPackage.INSTANT__VALUE:
				return getValue();
		}
